...
%   a. prototypical FRBs
%   b. detailed list of criteria; make a notebook
%   c. table/heat map of critera for FRBs, false-positives, pulsars; notebook
%   for each frb, and an output to form the heatmap from
