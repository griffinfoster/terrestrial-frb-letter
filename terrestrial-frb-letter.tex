...
extensive data. It is not always possible to caputre sufficient data to test
every criteria, nor is it possible with every observational setup. But, being
...
for studying the event but can hide instrumentational effects.  The last point,
...
% TODO: test observation of known pulsar near by in sky and time
...
should be made to do so. In the VOEvent trigger standard for \glspl{frb}
