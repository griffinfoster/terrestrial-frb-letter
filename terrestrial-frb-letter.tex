...
% TODO: state the FRBs are astrophysical, the repeater, multiple telescope,
% multiple band detections have proved that
...
%   telescope status
%   bandpass model and SEFD
%   gain variations
%   previous-in-time data
