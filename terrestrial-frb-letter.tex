...
maximized (10.46) when the pulse is dedispersed with a \gls{dm} of 293 pc
cm$^{-3}$ and the 256 microsecond resolution is decimated by a factor of 16 to
a time resolution of 4~ms. The dedispered time series shows an approximately 20
ms \gls{fwhm} pulse. The dip before and after the pulse is due to the DM-zero
...
% TODO: what are questions that can be answered?
