...
instrumentation. The repeater FRB121102 has been localized to a region of a
dwarf galaxy using VLBI \citep{2017ApJ...834L...7T,2017Natur.541...58C}. Bursts
from FRB121102 have been detected up to 8 GHz \citep{atel10675}. Bright bursts
are regularly detected with ASKAP and Molonglo
...
sources which, after further investigaton, we show to be terrestrial in origin.
...
across the radio band is a clear indicator of the origin of this event.
% TODO: awkward
The challenge comes
...
event occurs rarely and there is no obvious detection filter to automate. Expert
...
an \gls{frb}. The Nanshan L-band reciever is a single pixel system. It could be
