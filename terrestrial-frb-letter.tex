...
% TODO: also assuming a prototypical observation
...
% TODO: how is multi-component pulses useful to verification?
% better to be a single component than a complex multi-component pulse (positive
% vs. neutral). large gaps or a repreating structure such as RADAR is negative
% Deviates from the prototypical
...
% TODO: Marisa, can you make this point stronger?
% TODO: reference FRB
...
components, and vary signficiantly in spectral index. They vary significantly
from the prototypical \gls{frb} pulse shape and thus are considered neutral
evidence for an astrophysical source even though the locaction of the source is
...
% TODO: state that multi-site detection is the strongest evidence of
% astrophysical detection
