...
large structures across the band are present (top of Figure
\ref{fig:beam0_80s}). Though not as narrow-in-time as the event, they appear
related to the same phenomenon.  The DM$-$time plot (bottom of Figure
\ref{fig:beam0_80s}) shows that much of the structure would be detected as
dispersed pulses.  In particular, the structure around 4 seconds would be
...
\begin{figure*}
    ...
    shows frequency evolution of the bandpass as a function of time (e.g. around
    4 seconds) results in significant detections across the trial DM range -1600
    to 1600~pc~cm$^{-3}$.
    }
    \label{fig:beam0_80s}
\end{figure*}
