...
ALFABURST system at MJD 57726.563263913 / Unix time 1480858266 {\bf DRL: Why all
this detail of the time in the text?} (09:31:06 Arecibo local time on 2016,
...
fixed declination (+15:11:28.34) and drifting in RA (event detected at
RA=14:42:26.18).  {\bf DRL: why are the RA/DEC numbers needed here?} No known
pulsar or \gls{rrat} with a similar DM lies within the beam primary lobe of this
pointing.
...
(scintillation, plasma lensing \cMay{Need a reference here}). In the case of a single detected pulse, it would
...
so not having a broad-band signature does not entirely rule out an FRB. 
\cMay{In addition, what would be called a broad-band signal, also depends on the
observation frequency.} We expect this criterion to be improved by future telescope 
