...
\begin{figure}
    ...
    components separated by approximately 10~ms. Data is presented at the native
...
\begin{figure}
    ...
    521~pc~cm$^{-3}$.  Data is presented at the native recorded resolution of
...
during the time of detection. Though data is made public in many of the
detections, this data has all ready been normalized or calibrated so it is not
...
public data not only allows for independent verification, but also allows for
