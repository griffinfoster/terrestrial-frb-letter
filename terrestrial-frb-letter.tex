...
%is \cM{the result of/a combination of} \sout{due to} the pulse dispersion relation and the \cM{response of the} receiver system. A pulse with a dispersion relation similar to \cM{dispersion by a} cold plasma will still be detected in an
%\gls{frb} search pipeline with a significant \gls{snr}.
...
\cM{I suggest dropping the 4-depth heading numbering altogether and just leaving boldface font.}
